<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_CSS1.aspx.cs" Inherits="ICodeTogether.C_CSS1" MaintainScrollPositionOnPostback="true" ValidateRequest="false" %>
        ...
        <div class="dropdown">
           ...
           <span class="caret"></span>
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a href="C_CSS2.aspx">CSS套用</a></li>
                <li><a href="../StudyPage.aspx">回首頁選擇其他課程</a></li>
            </ul>
        </div>
        <div id="CSS1">
            <div class="page-header">
                <h1>CSS <small>簡介</small>
            ...
            <div id="gbcontent">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ICodeTogetherConnectionString %>" SelectCommand="SELECT * FROM [guestbook] WHERE ([UnitNo] = @UnitNo)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="U003" Name="UnitNo" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
        </div>
