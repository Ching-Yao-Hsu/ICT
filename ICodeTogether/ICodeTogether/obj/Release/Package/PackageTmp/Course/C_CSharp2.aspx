<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_CSharp2.aspx.cs" Inherits="ICodeTogether.C_CSharp2" MaintainScrollPositionOnPostback="true" ValidateRequest="false" %>
        ...
        <div class="dropdown">
           ...
           <span class="caret"></span>
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a href="C_CSharp.aspx">CSharp運算子</a></li>
        ...
        <div id="CSharp2">
            ...
            <div id="gbcontent">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ICodeTogetherConnectionString %>" SelectCommand="SELECT * FROM [guestbook] WHERE ([UnitNo] = @UnitNo)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="U006" Name="UnitNo" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
        </div>
