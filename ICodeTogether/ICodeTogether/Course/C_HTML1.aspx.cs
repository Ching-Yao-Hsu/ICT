...
{
    public partial class C_HTML1 : System.Web.UI.Page
    {
        ...
        protected void GetContent()
        {
            ...
            try
            {
                ...
                conn.Open();
                cmd.Connection = conn;
                cmd.CommandText = "select UnitContent from Unit where UnitNo = 'U001'";
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection())
                {
                    ...
                    cmd.Parameters["@unitNo"].Value = "U001";
                    cmd.ExecuteNonQuery();
